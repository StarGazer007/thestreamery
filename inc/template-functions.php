...
function streamer_password_form( $post = 0 ) {
	...
	<label class="post-password-form__label" for="' . esc_attr( $label ) . '">' . esc_html_x( 'Password', 'Post password form', 'streamer' ) . '</label><input class="post-password-form__input" name="post_password" id="' . esc_attr( $label ) . '" type="password" size="20" /><input type="submit" class="post-password-form__submit" name="' . esc_attr_x( 'Submit', 'Post password form', 'streamer' ) . '" value="' . esc_attr_x( 'Enter', 'Post password form', 'streamer' ) . '" /></form>
	';
	return $output;
}
